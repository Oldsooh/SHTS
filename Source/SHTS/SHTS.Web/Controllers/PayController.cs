            ...
            if (!string.IsNullOrEmpty(paymentName))
            {
                ...
                switch (paymentName)
                {
                    case PaymentService.ALIPAYSERVICE:
                        service = (IPayService)HttpContext.Cache.Get(PaymentService.ALIPAYSERVICE);
                        break;
                    case PaymentService.CHINABANKSERVICE:
                        service = (IPayService)HttpContext.Cache.Get(PaymentService.CHINABANKSERVICE);
                        break;
                    case PaymentService.TENPAYSERVICE:
                        service = (IPayService)HttpContext.Cache.Get(PaymentService.TENPAYSERVICE);
                        break;
                    default:
                        service = null;
                        break;
