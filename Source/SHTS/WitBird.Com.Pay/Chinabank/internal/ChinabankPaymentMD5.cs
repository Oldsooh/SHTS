...
namespace WitBird.Com.Pay.Chinabank
{
    ...
    /// </summary>
    internal sealed class ChinabankPaymentMD5
    {
        public ChinabankPaymentMD5()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        {
            string mysign = Sign(prestr, key, _input_charset).ToUpper();

            if (mysign.Equals(sign, System.StringComparison.CurrentCultureIgnoreCase))
            {
                return true;
            }
            else
